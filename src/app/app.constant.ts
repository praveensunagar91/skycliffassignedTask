  ...
  API_CONFIG: {
    ...
    API_URL: {
      ...
      SETTINGS: {
        ...
        GETDESIGNATION: 'GetDesignations',
        INSERTDESIGNATION: 'InsUpdateDesignation',
        DELETEDESIGNATION:'DeleteDesignation?DesignationId=',

        GETDOCUMENT: 'GetDocumentType',
        INSERTDOCUMENT:'InsUpdateDocumentType',
        DELETEDOCUMENT:'DeleteDocumentType?DocumentTypeId=',

        GETDEPARTMENT: 'GetDepartment',
        INSERTDEPARTMENT: 'InsertUpdateDepartment',
        DELETEDEPARTMENT:'DeleteDepartment?DepartmentId=',


        GETLOCATIONS: 'Getlocations',
        INSERTLOCATIONS: 'InsertUpdateLocation',
        DELETELOCATIONS:'DeleteLocation/?LocationId=',

        GETUSER: 'GetOrganizationMember/?organizationid=1',
      ...
      MEMBERS: {
        ...
        GETMEMBER: 'GetMemberById/?MemberId=1',
        SEARCH: 'GetMemberSearchResults/?Page=1&SearchString=',
